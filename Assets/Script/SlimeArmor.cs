...
public class SlimeArmor : MonoBehaviour
{
    ...
    void StateManager()
    {
        switch (state)
        {
            ...
            case enemyState.FURY:
                ...
                agent.stoppingDistance = _gameManager.slimeArmorDistanceAttack;
    ...
    void changeState(enemyState newState)
    {
        ...
        switch (state)
        {
            case enemyState.IDLE:
                ...
                break;
            case enemyState.PATROL:
                destino = _gameManager.slimeArmorPoints[Random.Range(0, _gameManager.slimeArmorPoints.Length)].position;
                agent.stoppingDistance = 0;
                agent.destination = destino;
    ...
    void GetHit(int dano)
    {
        ...
        else
        {
            ...
            isDie = true;
            Destroy(gameObject);
            _gameManager.xp = _gameManager.xp + 20;
        }
